...
<head>
	...
	<script src="<%=application.getContextPath()%>/resources/js/cmm/stockinfomore1.js"></script>
	<script src="<%=application.getContextPath()%>/resources/js/cmm/stockinfomore2.js"></script>
	<script src="<%=application.getContextPath()%>/resources/js/cmm/stockinfomore3.js"></script>
	<script src="<%=application.getContextPath()%>/resources/js/cmm/stockinfomore4.js"></script>
